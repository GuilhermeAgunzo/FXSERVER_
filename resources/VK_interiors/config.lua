INTERIORS = {
    ...
    -- FIB
    [4] = {id = 4, x = 139.02932739258, y = -762.67474365234, z = 45.752002716064, h = 158.28, name = "Exit FBI", destination = {5}},
    [5] = {id = 5, x = 136.09552001953, y = -761.82391357422, z = 242.1519317627, h = 336.85, name = "Enter FBI", destination = {4}},
...
-- Lawyer
	...
	-- FIB Arsenal
    [20] = {id = 20, x = 142.07, y = -769.40, z = 242.15,  name = "Enter FIB Arsenal", destination = {21}},
    [21] = {id = 21,x = 143.48, y = -770.02, z = 242.15,  name = "Exit FIB Arsenal", destination = {20}},
	-- New
