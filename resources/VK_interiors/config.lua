INTERIORS = {
    ...
    -- FIB
    [4] = {id = 4, x = 139.02932739258, y = -762.67474365234, z = 45.752002716064,  name = "Exit FBI", destination = {5}},
    [5] = {id = 5, x = 136.09552001953, y = -761.82391357422, z = 242.1519317627,  name = "Enter FBI", destination = {4}},
