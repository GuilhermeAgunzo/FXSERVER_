...
-- def
-- If any weapon is not saving in the inventory, check the list
local weapon_types = {
  "WEAPON_KNIFE",         -- MELEE WEAPONS (BEGIN)
  "WEAPON_SWITCHBLADE",
  "WEAPON_BOTTLE",
  "WEAPON_BAT",
  "WEAPON_CROWBAR",
  ...
  "WEAPON_DAGGER",
  "WEAPON_HATCHET",
  "WEAPON_MACHETE",      -- MELEE WEAPONS (END)
  "WEAPON_PISTOL",       -- PISTOLS (BEGIN)
  "WEAPON_REVOLVER",
  "WEAPON_COMBATPISTOL",
  ...
  "WEAPON_APPISTOL",
  "WEAPON_REVOLVER",
  "WEAPON_PISTOL50",     -- PISTOLS (END)
  "WEAPON_MICROSMG",     -- SMG (BEGIN)
  "WEAPON_MINISMG",
  "WEAPON_SMG",
  "WEAPON_ASSAULTSMG",
  "WEAPON_COMBATSMG",
  "WEAPON_COMBATPDW",    -- SMG (END)
  "WEAPON_ASSAULTRIFLE",   -- ASSAULT RIFLE (BEGIN)
  "WEAPON_CARBINERIFLE",
  "WEAPON_ADVANCEDRIFLE",
  "WEAPON_COMPACTRIFLE",
  "WEAPON_BULLPUPRIFLE",
  "WEAPON_SPECIALCARBINE", -- ASSAULT RIFLE (END)
  "WEAPON_MG",            -- MACHINE GUN (BEGIN)
  "WEAPON_COMBATMG",
  "WEAPON_GUSENBERG",
  "WEAPON_MINIGUN",       -- MACHINE GUN (END)
  "WEAPON_PUMPSHOTGUN",   -- SHOTGUN (BEGIN)
  "WEAPON_AUTOSHOTGUN",
  "WEAPON_DBSHOTGUN",
  "WEAPON_SAWNOFFSHOTGUN",
  "WEAPON_ASSAULTSHOTGUN",
  "WEAPON_BULLPUPSHOTGUN",
  "WEAPON_HEAVYSHOTGUN",  -- SHOTGUN (END)
  "WEAPON_SNIPERRIFLE",   -- SNIPER (BEGIN)
  "WEAPON_HEAVYSNIPER",
  "WEAPON_REMOTESNIPER",
  "WEAPON_MUSKET",
  "WEAPON_RAILGUN",
  "WEAPON_MARKSMANRIFLE", -- SNIPER (END)
  "WEAPON_GRENADELAUNCHER", -- MISC (BEGIN)
