...
cfg.selectors = {
  ["Job Selector"] = { -- original: x = -268.363739013672, y = -957.255126953125, z = 31.22313880920410, blipid = 351, blipcolor = 47
    _config = {x = -1082.04, y = -247.61, z = 37.76, blipid = 351, blipcolor = 47},
    "UBER",
    "Mechanic",
	"Delivery",
	"Bankdriver",
  ...
  ["Police job test 2"] = { -- Sandy Shores
