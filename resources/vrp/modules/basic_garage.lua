...
for group,vehicles in pairs(vehicle_groups) do
  ...
  local opt_owned = vehicles._config.opt.owned and true
  local opt_buy = vehicles._config.opt.buy and true
  local opt_sell = vehicles._config.opt.sell and true
  local opt_rent = vehicles._config.opt.rent and true
  local opt_store = vehicles._config.opt.store and true
